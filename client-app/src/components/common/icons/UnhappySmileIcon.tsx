...
/**
 * Icon name: sentiment_very_dissatisfied-black-24dp
 */
const UnhappySmileIcon: React.FC<IComponentProps> = ({ id, className, ...props }) => {
	return (
		<svg id={id} className={combineClassNames("icon unhappy-smile-icon", className)} viewBox="0 0 24 24" {...props}>
...
export default UnhappySmileIcon;

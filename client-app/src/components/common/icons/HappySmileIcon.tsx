...
/**
 * Icon name: sentiment_very_satisfied-black-24dp
 */
const HappySmileIcon: React.FC<IComponentProps> = ({ id, className, ...props }) => {
	return (
		<svg id={id} className={combineClassNames("icon happy-smile-icon", className)} viewBox="0 0 24 24" {...props}>

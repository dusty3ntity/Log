...
/**
 * Icon name: insert_invitation-24px
 */
const CalendarIcon: React.FC<IComponentProps> = ({ id, className, ...props }) => {
	return (
		<svg id={id} className={combineClassNames("icon calendar-icon", className)} viewBox="0 0 24 24" {...props}>

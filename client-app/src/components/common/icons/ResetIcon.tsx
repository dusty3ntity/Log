...
/**
 * Icon name: rotate_left-24px
 */
const ResetIcon: React.FC<IComponentProps> = ({ id, className, ...props }) => {
	return (
		<svg id={id} className={combineClassNames("icon reset-icon", className)} viewBox="0 0 24 24" {...props}>

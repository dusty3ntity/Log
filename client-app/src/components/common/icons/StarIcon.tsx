...
export interface IStarIconProps extends IComponentProps {
	active?: boolean;
}

/**
 * Icon name: star-black-24dp
 */
const StarIcon: React.FC<IStarIconProps> = ({ id, className, active, ...props }) => {
	return (
		<svg
			id={id}
			className={combineClassNames("icon star-icon", className, { active: active })}
			viewBox="0 0 24 24"
			{...props}
		>
			<g>

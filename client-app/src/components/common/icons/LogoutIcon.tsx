...
/**
 * Icon name: power_settings_new-24px
 */
const LogoutIcon: React.FC<IComponentProps> = ({ id, className, ...props }) => {
	return (
		<svg id={id} className={combineClassNames("icon logout-icon", className)} viewBox="0 0 24 24" {...props}>

...
/**
 * Icon name: wb_incandescent-black-24dp
 */
const LearningIcon: React.FC<IComponentProps> = ({ id, className, ...props }) => {
	return (
		<svg id={id} className={combineClassNames("icon learning-icon", className)} viewBox="0 0 24 24" {...props}>

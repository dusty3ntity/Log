...
// sentiment_very_satisfied-black-24dp

interface IProps {
	className?: string;
}

const HappySmileIcon: React.FC<IProps> = ({ className }) => {
	return (
		<svg className={"icon happy-smile-icon " + (className ? className : "")} viewBox="0 0 24 24">

...
// sentiment_very_dissatisfied-black-24dp

interface IProps {
	className?: string;
}

const UnhappySmileIcon: React.FC<IProps> = ({ className }) => {
	return (
		<svg className={"icon unhappy-smile-icon " + (className ? className : "")} viewBox="0 0 24 24">
